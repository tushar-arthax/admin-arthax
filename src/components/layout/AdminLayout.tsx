...
import { Building2, KeyRound, LayoutDashboard, LifeBuoy, LogOut, Settings, ShieldAlert, Bell  } from 'lucide-react';
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { name: 'Support Access', path: '/support-access', icon: <KeyRound className="w-5 h-5" /> },
  ];
